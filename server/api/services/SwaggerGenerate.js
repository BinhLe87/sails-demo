    ...
    generate: function () {
        ...
        let options = {
            swaggerDefinition: {
                "swagger": "2.0",
                "info": {
                    "description": "API for blockpass backend project",
                    "version": "0.0.1",
                    "title": "Blockpass API Document",
                    "contact": {
                        "email": "thainq@cardano-labo.com"
                    }
                },
                "host": "",
                "basePath": "/",
            ...
            basedir: sails.config.appPath, //app absolute path
        ...
        let filePath = path.resolve(sails.config.appPath, "docs", "swagger.json");

        swaggerObject = JSON.stringify(swaggerObject)

        fs.writeFileSync(filePath, swaggerObject)
        return
    }
};